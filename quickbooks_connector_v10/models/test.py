...
class stock_picking(osv.osv):
    ...
    def generate_quick_data(self, cr, uid, ids, context):
        ...
        oauth = OAuth1Session(clientkey, clientsecret, callback_uri='http://planet-odoo.in:1234/web?db=helpdesk_ext#id=3&view_type=form&model=stock.picking&action=349&active_id=2')
...
#        redirect_response = raw_input('Paste the full redirect URL here : ')
        redirect_response = 'http://planet-odoo.in:1234/?oauth_token=qyprdyT5RrH4QvBQgDKqUkjr4gb7YRLrbFyeTRREwpJKW87J&oauth_verifier=yyqa7tz&realmId=193514292321532&dataSource=QBO'
